...
const projects = [
  { 
    ...
    type: 'Client Project',
    tech: 'Full Stack',
    description: 'A comprehensive event ticketing platform with real-time booking',
  ...
  { 
    ...
    tech: 'Frontend',
    description: 'Modern real estate platform with property listings and search',
  ...
  { 
    ...
    type: 'Personal Project',
    tech: 'Frontend',
    description: 'Interactive ticket booking system with seat selection and real-time pricing',
    image: '/Image/ticket.png'
  },
]

const skills = {
  frontend: ['HTML', 'CSS', 'Tailwind CSS', 'JavaScript', 'React', 'DaisyUI', 'Material UI'],
...
const educationData = [
  {
    ...
    websites, dynamic applications, and full-stack projects. The course also helped me understand 
    ...
    skills: ['HTML & CSS', 'JavaScript', 'React', 'Node.js', 'Express.js', 'MongoDB', 'API Integration', 'Git/GitHub'],
    icon: (
  ...
  },
  {
    ...
    skills: ['Layout Design', 'Color Theory', 'Typography', 'Figma', 'User Analysis'],
    icon: (
      <svg className="w-7 h-7 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const Home = () => {
  ...
  const prevSlide = () => {
    setCurrentEducation((prev) => (prev - 1 + educationData.length) % educationData.length)
  }

  const copyEmailToClipboard = () => {
    const email = 'ashik70021@gmail.com'
  ...
  return (
    <main className="min-h-screen text-gray-100">
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative flex flex-col items-center">
              <div className="relative">
                ...
                <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-2xl overflow-hidden ring-4 ring-indigo-500/30 shadow-2xl">
                  <img
                    src="/Image/sajib.jpg"
                    alt="Md Ashikur Rahman Sajib"
              ...
              <div className="flex gap-4 mt-6">
                <div className="relative group">
                  <button
                    ...
                    className="w-12 h-12 bg-gray-800/50 hover:bg-indigo-600 rounded-full flex items-center justify-center transition-all hover:scale-110 border border-gray-700 hover:border-indigo-500"
                    title="Copy Email"
                  >
                  ...
                  {/* Hover tooltip */}
                  <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-xs px-3 py-1 rounded-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none border border-gray-700">
                    ashik70021@gmail.com
                  </div>
                  {/* Copied message */}
                  {copied && (
                    <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-green-600 text-white text-xs px-3 py-1 rounded-md whitespace-nowrap">
                      Email copied!
                    </div>
                  )}
                </div>
                ...
                <a
                  href="https://wa.me/8801620223700"
                  target="_blank"
                  rel="noreferrer"
                  className="w-12 h-12 bg-gray-800/50 hover:bg-green-600 rounded-full flex items-center justify-center transition-all hover:scale-110 border border-gray-700 hover:border-green-500"
                  title="WhatsApp"
                >
                  <svg className="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  href="https://www.linkedin.com/in/ashikur-rahman-sajib/"
                  target="_blank"
                  rel="noreferrer"
                  className="w-12 h-12 bg-gray-800/50 hover:bg-blue-600 rounded-full flex items-center justify-center transition-all hover:scale-110 border border-gray-700 hover:border-blue-500"
                  title="LinkedIn"
                >
                  <svg className="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  href="https://github.com/Ashik70021"
                  target="_blank"
                  rel="noreferrer"
                  className="w-12 h-12 bg-gray-800/50 hover:bg-gray-700 rounded-full flex items-center justify-center transition-all hover:scale-110 border border-gray-700 hover:border-gray-500"
                  title="GitHub"
                >
                  <svg className="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="container mx-auto px-6 py-12">
        ...
        <p className="text-center text-gray-400 mb-10">Technologies I work with</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-yellow-500 transition-all">
            <h3 className="text-xl font-semibold mb-4 text-yellow-400">Database</h3>
            <div className="flex flex-wrap gap-2">
      ...
      {/* Education Section */}
      <section className="container mx-auto px-6 py-12">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-10">Education & Training</h2>
                  ...
                  <div className={`${
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className={`${
                          edu.highlighted ? 'text-indigo-400' : 'text-gray-400'
                        } font-medium mb-4`}>
                          {edu.institution}
                        </p>
      ...
      <section id="projects" className="container mx-auto px-6 py-12">
        ...
        <p className="text-center text-gray-400 mb-10">Client & personal projects I&apos;ve built</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group block bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 hover:border-indigo-500 transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-2 overflow-hidden animate-fade-in"
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                />
                <div className="absolute top-4 right-4 z-20 w-10 h-10 bg-gray-900/80 backdrop-blur-sm rounded-full flex items-center justify-center border border-gray-700 group-hover:border-indigo-400 transition-all">
                  <svg className="w-5 h-5 text-gray-400 group-hover:text-indigo-400 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="font-bold text-xl group-hover:text-indigo-400 transition-colors">{project.title}</h3>
                </div>
                <p className="text-sm text-gray-400 mb-3 line-clamp-2">{project.description}</p>
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-500">{project.type}</span>
                  <span className="text-xs px-3 py-1 bg-indigo-500/20 text-indigo-300 rounded-full border border-indigo-500/30 group-hover:bg-indigo-500/30 transition-colors">
                    {project.tech}
                  </span>
                </div>
              </div>
      ...
      <section className="container mx-auto px-6 py-12">
        ...
        <p className="text-center text-gray-400 mb-10">My professional journey</p>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="relative pl-8 pb-8 border-l-2 border-indigo-500/30">
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-indigo-500 transition-all">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                <div>
                  <h3 className="text-xl font-semibold text-indigo-300">Junior Web Developer</h3>
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                I worked as a Junior Web Developer at bdCalling IT, where I helped develop and maintain websites 
                using HTML, CSS, JavaScript, and PHP. I supported senior developers by adding new features, fixing 
                bugs, and improving website performance. I worked with MySQL databases, integrated APIs, and ensured 
                responsive design for better user experience. I also used Git for version control and collaborated 
                with the team to meet project requirements and deliver updates on time.
              </p>

              <div className="flex flex-wrap gap-2">
                <span className="text-xs px-3 py-1 bg-gray-800 text-gray-300 rounded-full border border-gray-700">HTML/CSS</span>
                <span className="text-xs px-3 py-1 bg-gray-800 text-gray-300 rounded-full border border-gray-700">JavaScript</span>
                <span className="text-xs px-3 py-1 bg-gray-800 text-gray-300 rounded-full border border-gray-700">PHP</span>
                <span className="text-xs px-3 py-1 bg-gray-800 text-gray-300 rounded-full border border-gray-700">MySQL</span>
                <span className="text-xs px-3 py-1 bg-gray-800 text-gray-300 rounded-full border border-gray-700">API Integration</span>
                <span className="text-xs px-3 py-1 bg-gray-800 text-gray-300 rounded-full border border-gray-700">Git</span>
              </div>
            </div>
          </div>
          ...
          {/* <div className="relative pl-8">
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-purple-500 transition-all">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                <div>
                  <h3 className="text-xl font-semibold text-purple-300">Freelance Web Developer</h3>
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                Working as a freelance web developer, delivering full-stack web solutions to local and international 
                clients. Specializing in building responsive, user-friendly websites and web applications using modern 
                technologies. Successfully completed multiple client projects including e-commerce platforms, business 
                websites, and custom web applications. Managing projects from initial consultation through deployment 
                and maintenance.
              </p>

              <div className="flex flex-wrap gap-2">
                <span className="text-xs px-3 py-1 bg-gray-800 text-gray-300 rounded-full border border-gray-700">Full-Stack Development</span>
                <span className="text-xs px-3 py-1 bg-gray-800 text-gray-300 rounded-full border border-gray-700">React</span>
                <span className="text-xs px-3 py-1 bg-gray-800 text-gray-300 rounded-full border border-gray-700">Node.js</span>
                <span className="text-xs px-3 py-1 bg-gray-800 text-gray-300 rounded-full border border-gray-700">MongoDB</span>
      ...
      <section id="contact" className="container mx-auto px-6 py-12 mb-12">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <button
              onClick={copyEmailToClipboard}
              className="group bg-gradient-to-br from-indigo-500/10 to-purple-500/10 backdrop-blur-sm p-6 rounded-xl border-2 border-indigo-500/30 hover:border-indigo-500 transition-all hover:shadow-xl hover:shadow-indigo-500/20 hover:-translate-y-1 cursor-pointer relative"
            >
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className={`font-medium break-all text-sm ${copied ? 'text-green-400' : 'text-indigo-400 group-hover:text-indigo-300'}`}>
                  ashik70021@gmail.com
                </p>
              </div>
            </button>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-200 mb-2">WhatsApp</h3>
                <p className="text-green-400 font-medium group-hover:text-green-300">+880 1620 223700</p>
              </div>
            </a>

            {/* Facebook Card */}
            <a 
              href="https://www.facebook.com/ashikur.1010"
              target="_blank"
              rel="noreferrer"
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-200 mb-2">Facebook</h3>
                <p className="text-blue-500 font-medium group-hover:text-blue-400">Follow me</p>
              </div>
            </a>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-200 mb-2">LinkedIn</h3>
                <p className="text-blue-400 font-medium group-hover:text-blue-300">Connect with me</p>
              </div>
            </a>
          </div>
        </div>
