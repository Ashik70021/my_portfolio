            ...
            <div className="container mx-auto px-6 py-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p className="text-sm text-gray-400 leading-relaxed">
                            Full-Stack Web Developer specializing in building beautiful, 
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-2 mb-4">
                            <a href="mailto:ashik70021@gmail.com" className="text-sm text-gray-400 hover:text-indigo-400 transition-colors">
                                ashik70021@gmail.com
                            </a>
                            <a href="tel:+8801620223700" className="text-sm text-gray-400 hover:text-indigo-400 transition-colors">
                                +880 1620 223700
                            </a>
                        </div>
                        <h6 className="font-semibold text-gray-200 mb-3 mt-4">Quick Links</h6>
                        <div className="flex flex-col gap-2">
                            <a href="#projects" className="text-sm text-gray-400 hover:text-indigo-400 transition-colors">
                                Projects
                            </a>
                ...
                <div className="border-t border-gray-800 mt-8 pt-6 text-center">
                    <p className="text-sm text-gray-500">
                        © {new Date().getFullYear()} Md Ashikur Rahman Sajib. All rights reserved. Built with React & Tailwind CSS.
                    </p>
                </div>
            </div>
        </footer>
